-- 207_pkm_manifest_display_segment.sql
--
...
COMMENT ON COLUMN pkm_manifest_paths.display_segment IS
  'This path''s final segment as the owner''s data spelled it. NULL for synthetic collection segments (_items, _entities) and for rows written before migration 207.';
