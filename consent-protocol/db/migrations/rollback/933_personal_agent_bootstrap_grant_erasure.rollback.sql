...
DROP FUNCTION IF EXISTS public.retain_erasure_bootstrap_grant_receipt(text,text,jsonb,text,text,jsonb);
DROP FUNCTION IF EXISTS public.reserve_erasure_bootstrap_grants(text,text,jsonb,text);
DROP FUNCTION IF EXISTS public.valid_erasure_bootstrap_append(jsonb,jsonb);
DROP FUNCTION IF EXISTS public.expected_erasure_bootstrap_release(text,jsonb,text);
COMMIT;
