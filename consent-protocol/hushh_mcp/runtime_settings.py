...
_BACKEND_RUNTIME_ENV_MAP: dict[str, str] = {
    ...
    "one_payment_cards_enabled": "ONE_PAYMENT_CARDS_ENABLED",
...
def one_payment_cards_enabled() -> bool:
    """Feature flag: expose the Payment Cards plane — writes to the reserved
    ``payment_cards`` PKM domain and the Cards specialist in One's roster.
    Defaults off; while off payment_cards store-domain writes are refused and
    ...
    return _bool_from_value(_clean_env("ONE_PAYMENT_CARDS_ENABLED"), default=False)
