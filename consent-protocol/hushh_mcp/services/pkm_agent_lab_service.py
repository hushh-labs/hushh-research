    ...
    def _build_structure_prompt(
        ...
        *,
        ...
        return (
            ...
            "- Choose the action deliberately. match_existing_domain when a domain in Current top-level PKM domains or Soft ontology domain choices already fits. extend_domain when it fits but needs a new subtree. create_domain ONLY when nothing offered is semantically accurate.\n"
