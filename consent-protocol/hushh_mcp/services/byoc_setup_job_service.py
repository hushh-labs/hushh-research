...
class ByocSetupJobRepo:
    ...
    async def park_cloud(
        ...
        *,
        ...
        """Use the existing setup publication authority."""
        from hushh_mcp.services.byoc_cloud_publication import park_cloud

        return await park_cloud(
            self,
            user_id=user_id,
            project_id=project_id,
            region=region,
    ...
    async def record_proven_cloud(
        ...
        *,
        ...
        """Use the existing setup publication authority."""
        from hushh_mcp.services.byoc_cloud_publication import record_proven_cloud

        return await record_proven_cloud(
            self,
            user_id=user_id,
            job_id=job_id,
            project=project,
