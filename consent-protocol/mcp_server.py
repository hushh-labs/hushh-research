...
from mcp_modules.tools.consumer_tools import (
    ...
    handle_delete_hussh_memory,
    handle_disconnect_hussh_connection,
    handle_disconnect_hussh_integration,
    ...
    handle_get_hussh_email_workflow,
    ...
    handle_list_hussh_email_workflows,
    handle_list_hussh_gmail_receipts,
    handle_list_hussh_integrations,
    handle_list_hussh_people_connections,
    handle_list_hussh_receipts,
    handle_open_hussh_email_workflow,
...
HANDLERS = {
    ...
    "get_hussh_gmail_status": handle_get_hussh_gmail_status,
    "list_hussh_email_workflows": handle_list_hussh_email_workflows,
    "get_hussh_email_workflow": handle_get_hussh_email_workflow,
    "open_hussh_email_workflow": handle_open_hussh_email_workflow,
    "list_hussh_integrations": handle_list_hussh_integrations,
    "list_hussh_gmail_receipts": handle_list_hussh_gmail_receipts,
    ...
    "get_hussh_person_profile": handle_get_hussh_person_profile,
    ...
    "delete_hussh_memory": handle_delete_hussh_memory,
    "export_hussh_memory": handle_export_hussh_memory,
