...
MIGRATION_NAME = "172_hushh_tech_uat_client_foundation.sql"
ROLLBACK_NAME = "172_hushh_tech_uat_client_foundation.rollback.sql"
...
def test_rollback_refuses_nonempty_tables_and_drops_only_migration_170_tables() -> None:
