    ...
    return (
      <div
        ...
        className={cn(
          ...
          active && "bg-primary/10 text-foreground ring-1 ring-primary/20 dark:bg-primary/15",
          ...
          <div className="border-b border-black/10 px-3 py-2 dark:border-white/10">
            <div className="relative">
              ...
              <Input
                ...
                autoCorrect="off"
                spellCheck={false}
                className="h-9 border-border bg-muted/50 pl-8 text-sm text-foreground placeholder:text-muted-foreground"
              />
            </div>
          </div>
        ) : null}
