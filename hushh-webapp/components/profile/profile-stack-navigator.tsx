        ...
        {screens.map((entry, index) => (
          ...
          >
            {entry.isRoot ? (
              ...
              >
                <div
                  className="mx-auto flex w-full max-w-[720px] flex-col px-[var(--page-inline-gutter-standard)] pb-[calc(env(safe-area-inset-bottom)+var(--surface-stack-gap-standard))] pt-0 sm:pb-10"
