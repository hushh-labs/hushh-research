  ...
  return (
    <div className="space-y-4">
      ...
      <Dialog open={previewOpen} onOpenChange={onPreviewOpenChange}>
        ...
        >
          <div className="sticky top-0 z-20 grid grid-cols-[minmax(0,1fr)_2.75rem] items-start gap-4 border-b border-[color:var(--app-card-border-standard)] bg-[color:var(--app-card-surface-default-solid)] px-8 pb-4 pt-5 sm:px-9">
