...
import { Check, ChevronsUpDown, FilePenLine, X } from "@/components/icons";
...
const COMMAND_ITEM_CLASSNAME =
  "rounded-[18px] border border-transparent px-3 py-3 transition-[background-color,border-color,color,transform] duration-100 ease-out active:scale-[0.98] hover:bg-[color:var(--app-accent-surface)] hover:text-foreground data-[selected=true]:bg-[color:var(--app-accent-surface)] data-[selected=true]:text-foreground data-[disabled=true]:pointer-events-none data-[disabled=true]:opacity-45";
                ...
                >
                  {renderOption ? (
                    ...
                    <>
                      ...
                      {selected ? <Check className="h-4 w-4 text-[color:var(--app-accent)]" aria-hidden="true" /> : null}
                    </>
                  )}
                </CommandItem>
              );
