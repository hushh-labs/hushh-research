      ...
      <div className="morphy-theme-content relative flex h-full flex-col overflow-hidden p-5 sm:p-6">
        <div className="relative flex h-full flex-col">
          <div>
            ...
            <span className="type-caption inline-flex items-center rounded-full bg-emerald-500/12 px-[11px] py-[5px] text-emerald-600 dark:text-emerald-300">
              Verified
            </span>
            </div>
          ...
          <div className="flex flex-1 flex-col justify-center divide-y divide-border/70 py-3">
            {KYC_ITEMS.map((item) => (
              ...
              >
                ...
                <span className="type-headline flex-1">
                  {item.label}
                </span>
          ...
          <div className="flex items-center gap-[13px] border-t border-border/70 pt-4">
            ...
            <div>
              ...
              <p className="type-footnote mt-0.5 text-muted-foreground">
