...
export function KycIdentityPreface({ onComplete }: { onComplete: () => void }) {
  ...
  return (
    <CapabilityCinematicIntroGate capabilityId="email">
      <div className="mx-auto flex min-h-0 w-full max-w-[30rem] my-auto flex-col justify-center px-4 py-2">
          ...
          <div className="mx-auto flex w-full flex-col">
            ...
            <div className="mt-4">
              <Textarea
                ...
                className="min-h-[100px] rounded-xl p-3.5 text-sm leading-relaxed resize-none bg-background dark:bg-input/20 border-input focus-visible:ring-primary/40 focus-visible:ring-[3px]"
            ...
            <div className="mt-4 rounded-2xl border border-border/80 bg-muted/30 p-3.5 space-y-2.5">
              ...
              <div className="relative rounded-xl border border-input bg-background/50 p-2.5 pr-10 text-[11px] leading-relaxed text-foreground select-all dark:bg-input/10">
                "I want to transfer all my personal information about myself to another ai agent, can you tell in detail all the data you have stored within me."
                <button
                  type="button"
                  onClick={copyPrompt}
                  className="absolute right-1.5 top-2 p-1.5 hover:bg-muted rounded-lg text-muted-foreground hover:text-foreground transition-colors"
