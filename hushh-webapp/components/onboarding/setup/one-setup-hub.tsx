...
export function OneSetupHub() {
  ...
  return (
    ...
    >
      ...
      {!storyTakeoverActive ? (
        <AppPageHeaderRegion>
          {/* The mobile master-ack button that used to sit in this row is gone:
              the completion footer below is no longer desktop-only, so a header
              copy of the same action would be a second control for one job. */}
          <PageHeader
            title={
