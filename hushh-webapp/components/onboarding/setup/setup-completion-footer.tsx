  ...
  return (
    <div
      className={cn(
        "mt-6 sm:mt-8",
        insetBottom
          ? "pb-[calc(var(--app-scroll-bottom-pad,var(--onboarding-agent-bar-clearance,4rem))+1.5rem)] sm:pb-10"
          : "pb-[calc(var(--onboarding-agent-bar-clearance,3.5rem)+0.5rem)] sm:pb-8",
      )}
    >
