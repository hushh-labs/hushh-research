...
function ContactsScreen({
  ...
  return (
    ...
    >
      ...
      <header className="min-h-16 shrink-0 px-5 pb-2 pt-[max(var(--app-safe-area-top-effective,0px),8px)] lg:px-10">
      ...
      <div className="min-h-0 flex-1 overflow-y-auto px-6 pb-4 lg:px-10 lg:pb-6">
        <div className="mx-auto w-full max-w-[1040px] lg:grid lg:min-h-full lg:grid-cols-[minmax(0,0.92fr)_minmax(390px,480px)] lg:items-center lg:gap-14">
          <div className="lg:max-w-[430px]">
            <span className="mt-2 flex h-14 w-14 items-center justify-center rounded-2xl bg-[color:var(--app-accent-soft)] text-[color:var(--app-accent)] lg:h-16 lg:w-16 lg:rounded-[22px]">
              <UserPlus className="h-7 w-7 lg:h-8 lg:w-8" strokeWidth={2} />
            </span>
            <h1 className="ui-text-agent-title mt-4 text-[#151b26] dark:!text-[color:var(--app-label)] lg:mt-6">
              Find your people
            </h1>
            <p className="mt-2 text-[15px] font-normal leading-[20px] text-[#73777f] dark:text-[color:var(--app-secondary-label)] lg:max-w-[360px]">
              {primed
                ? "Find people already on One."
                : state.kind === "matched"
          ...
          <div className="lg:flex lg:w-full lg:justify-center">
            {primed ? (
              <>
                <div className="mt-7 w-full rounded-[20px] border border-[#e4e6e9] bg-[#f8f9fb] p-6 dark:border-[color:var(--app-separator)] dark:bg-[color:var(--app-primary-surface)] lg:mt-0 lg:max-w-[430px] lg:p-7">
                  {state.kind === "busy" ? (
                    ...
                    <div className="flex min-h-32 flex-col justify-center gap-4">
                      <p className="text-[15px] leading-5 text-[#5c626c] dark:text-[color:var(--app-secondary-label)]">
                        Connect contacts to see who's here.
                      </p>
            ...
            {state.kind === "none" ? (
              <div className="mt-7 rounded-[20px] border border-[#e4e6e9] bg-[#f8f9fb] p-6 text-center dark:border-[color:var(--app-separator)] dark:bg-[color:var(--app-primary-surface)]">
                ...
                <p className="mt-2 text-[13px] leading-5 text-[#96999e] dark:text-[color:var(--app-secondary-label)]">
                  Your circle code is on the next screen — send it to whoever
                  you want here.
                </p>
              </div>
            ) : null}
      ...
      <footer className="mx-auto w-full max-w-[1040px] shrink-0 px-6 pb-[calc(env(safe-area-inset-bottom,0px)+18px)] pt-3 lg:flex lg:justify-end lg:px-10 lg:pt-0">
