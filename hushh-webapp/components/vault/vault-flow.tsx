    ...
    <div className="pt-2">
      {showSignOutConfirm ? (
        <div
          ...
          className="rounded-[22px] border border-[rgba(156,116,52,0.18)] bg-[rgba(156,116,52,0.06)] p-3 text-center"
        >
          ...
          <div className="mt-3 grid grid-cols-2 gap-2">
            ...
            <button
              ...
              disabled={isSigningOut}
              className="inline-flex min-h-11 items-center justify-center rounded-full bg-[#9C7434] px-3 type-footnote font-semibold text-white shadow-[0_10px_24px_rgba(156,116,52,0.24)] disabled:opacity-50"
            >
        ...
        >
          ...
          <span className="font-semibold text-[#9C7434] underline-offset-2 hover:underline dark:text-[#D4AF6A]">
            Sign out
          </span>
        </button>
      )}
