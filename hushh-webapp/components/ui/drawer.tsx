  ...
  return (
    <DrawerPortal data-slot="drawer-portal">
      ...
      <DrawerPrimitive.Content
        ...
        className={cn(
          "group/drawer-content fixed z-(--z-sheet) flex h-auto flex-col border-[color:var(--app-card-border-standard)] bg-[color:var(--app-card-surface-default-solid)] shadow-[var(--app-card-shadow-feature)]",
          "data-[vaul-drawer-direction=top]:inset-x-0 data-[vaul-drawer-direction=top]:top-0 data-[vaul-drawer-direction=top]:mb-24 data-[vaul-drawer-direction=top]:max-h-[80vh] data-[vaul-drawer-direction=top]:rounded-b-[var(--app-card-radius-feature)] data-[vaul-drawer-direction=top]:border-b",
          ...
          // whole sheet is the only reliable avoidance under Capacitor
          // resize:"none" (the webview viewport never shrinks, so scrollIntoView
          // alone can't clear the keyboard). max-h shrinks by the same amount so
          // the lifted sheet never overflows the top. See mobile-bug-log B21.
          "data-[vaul-drawer-direction=bottom]:inset-x-0 data-[vaul-drawer-direction=bottom]:bottom-[var(--kb-height,0px)] data-[vaul-drawer-direction=bottom]:mt-24 data-[vaul-drawer-direction=bottom]:max-h-[calc(80vh-var(--kb-height,0px))] data-[vaul-drawer-direction=bottom]:rounded-t-[var(--app-card-radius-feature)] data-[vaul-drawer-direction=bottom]:border-t",
        ...
        {...props}
      >
        <div className="mx-auto mt-4 hidden h-1.5 w-10 shrink-0 rounded-full bg-[color:var(--app-secondary-label)]/35 group-data-[vaul-drawer-direction=bottom]/drawer-content:block" />
