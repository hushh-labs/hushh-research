...
>(({ className, ...props }, ref) => (
  <AlertDialogPrimitive.Overlay
    className={cn(
      "fixed inset-0 z-50 bg-black/80 backdrop-blur-sm data-[state=open]:animate-in data-[state=closed]:animate-out data-[state=closed]:fade-out-0 data-[state=open]:fade-in-0 custom-alert-dialog-overlay",
      className
    )}
    ref={ref}
    {...props}
...
AlertDialogTitle.displayName = "AlertDialogPrimitiveTitle"
