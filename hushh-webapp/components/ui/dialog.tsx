  ...
  return (
    <DialogPrimitive.Overlay
      ...
      className={cn(
        ...
        "data-[state=open]:animate-in data-[state=closed]:animate-out data-[state=closed]:fade-out-0 data-[state=open]:fade-in-0 duration-150 ease-out fixed inset-0 z-[800] touch-none bg-black/24 backdrop-blur-[12px] [-webkit-backdrop-filter:blur(12px)]",
        className
      )}
      {...props}
    />
