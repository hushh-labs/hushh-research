...
const PERMISSION_OPTIONS: Array<{
  ...
  {
    key: "outsideAccounts",
    label: "Outside account summaries",
    required: false,
  },
...
export function KaiInviteHandshake({ inviteToken }: { inviteToken: string }) {
  ...
  const title = useMemo(() => {
    if (!invite) return "Advisor invite";
            ...
            {step === 0 ? (
              <>
                ...
                <p className="mt-3 text-sm leading-7 text-muted-foreground">
                  We work in the background to connect you and your advisor
              ...
              <div className="space-y-4">
                ...
                <SurfaceInset className="p-5">
                  <p className="text-lg font-semibold text-foreground">
                    {invite.ria.display_name}
                  </p>
                  <p className="mt-1 text-sm text-muted-foreground">
                    {invite.ria.headline ||
                      invite.ria.strategy_summary ||
                ...
                {PERMISSION_OPTIONS.map(({ key, label, required }) => (
                  ...
                  >
                    <span className="text-sm text-foreground">
                      {label}{" "}
                      {required ? (
                        <span className="text-amber-200">required</span>
                      ) : null}
                    </span>
            ...
            {step === 4 ? (
              <div className="space-y-4 text-center">
                ...
                <p className="text-sm leading-7 text-muted-foreground">
                  ...
                  access request from Consents after your setup is complete.
                </p>
              </div>
            ) : null}
          </div>
