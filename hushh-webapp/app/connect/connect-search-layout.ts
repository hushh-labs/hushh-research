...
export const CONNECT_SELECT_TOGGLE_CLASSNAME =
  "ui-text-compact-button-label h-11 min-h-11 w-[72px] shrink-0 rounded-full px-0";
...
export const CONNECT_PAGE_SIZE_TRIGGER_CLASSNAME =
  "ui-text-compact-button-label h-11 min-h-11 w-auto min-w-[108px] shrink-0 rounded-full border border-[color:var(--app-card-border-standard)] bg-[color:var(--app-secondary-fill)] px-3 shadow-none hover:bg-[color:var(--app-tertiary-fill)]";
...
export const CONNECT_PAGE_STATUS_CLASSNAME =
  "ui-text-helper-text tabular-nums text-[color:var(--app-secondary-label)]";
...
export const CONNECT_PAGER_BUTTON_CLASSNAME =
  "ui-text-compact-button-label h-11 min-h-11 rounded-full px-4";
