export const CURRENT_PKM_MODEL_VERSION = 5;
export const CURRENT_READABLE_SUMMARY_VERSION = 5;
export const CURRENT_PKM_CONTRACT_VERSION = "5.0.0";
export const CURRENT_READABLE_PROJECTION_VERSION = "5.0.0";
export const CURRENT_DYNAMIC_DOMAIN_CONTRACT_VERSION = 3;
