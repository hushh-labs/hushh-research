...
/**
 * Morphy UX surface primitives.
 *
 * Promoted from the One Location redesign (the reference implementation for
 * app-surface polish). Every component here is prop-driven and stateless
 * w.r.t. business logic. Typography matches the app-wide system: titles use
 ...
 * SurfaceCardTitle — so features composing these look identical everywhere.
 *
 * Accent usage flows through the --app-accent family (iOS Blue default,
 * Molten Gold under html[data-accent="gold"]). Never hardcode accent hexes.
 */
