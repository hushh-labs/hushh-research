...
export interface PlaidPortfolioStatusResponse {
  ...
  /**
   * Where the connections' Plaid tokens live: always sealed in the person's
   * encrypted memory (the status is built on the device). The server-held
   * flow was removed on 2026-09-23.
   */
  custody: "vault";
}
