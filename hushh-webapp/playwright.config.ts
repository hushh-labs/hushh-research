...
export default defineConfig({
  ...
  projects: [
    ...
    },
    {
      ...
      testMatch:
        /(circle-join-responsive-contract|connect-circle-cta\.layout|one-location-requests-sent-row\.layout|one-location-duration-ladder\.layout|one-location-check-in-panel\.layout|gemini-endpoint-fields\.layout|feed-needs-you-row\.layout|one-location-tab-strip\.layout|app-shell-top-clearance\.layout|app-shell-bottom-clearance\.layout)\.spec\.ts/,
    },
    {
      name: "firefox",
