...
| "Admin means I can deploy a green PR SHA" | Admin may bypass the merge queue only through the documented direct-main preflight and exact-head merge; UAT still requires landed `main` and successful `Main Post-Merge Smoke`. |
