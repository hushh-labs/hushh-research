...
Apply `AGENTS.md` and the owning frontend design-system contract first. This is
optional task guidance, not authority to replace established product conventions.
...
_A curated terminology reference; verify project-specific behavior against its implementation._
