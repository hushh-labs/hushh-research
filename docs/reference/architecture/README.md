...
- [mega-map.md](./mega-map.md): the Hussh Mega Map — one source-grounded picture of the whole platform (seven layers + ten end-to-end user-story flows), published as a living SVG. Generated by `hussh-mega-map.gen.py`.
