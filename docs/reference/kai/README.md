...
flowchart TD
  ...
  root --> n12
  n10["One Voice Kai Compatibility Runtime"]
  root --> n10
...
One-owned product-surface contracts live in [../one/README.md](../one/README.md).
...
- `Kai` is the current mature finance-specialist intelligence runtime, not the platform-level identity
