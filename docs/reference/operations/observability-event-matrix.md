...
| `one_calendar_action` | `connected`, `disconnected`, `chat_opened` | Calendar owner workspace | Connector adoption and assistance handoffs; opening chat is not an agent answer |
