...
- Maintainer-only overlays such as app-review, `REVIEWER_UID` / `REVIEWER_VAULT_PASSPHRASE`, rehearsal toggles, and native signing inputs are intentionally excluded from the canonical runtime matrix.
