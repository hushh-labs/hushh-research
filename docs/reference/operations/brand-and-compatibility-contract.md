...
7. package names, bundle IDs, class names, plugin names, table names, and service names
...
3. [../architecture/founder-language-matrix.md](../architecture/founder-language-matrix.md)
