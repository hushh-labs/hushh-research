...
| `hushh-webapp/components/agent/specialist-directive-card.tsx` **(new)** | Presentational Location action & prompt cards; reuse styling from the existing location `ActionConfirmCard`.                                                                                                                                           |
