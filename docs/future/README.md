...
flowchart TD
  ...
  requests["pr-request-backlog.md<br/>PR request governance note"]
...
- [pr-request-backlog.md](./pr-request-backlog.md): planning-only governance note for PR request workflows and execution boundaries
