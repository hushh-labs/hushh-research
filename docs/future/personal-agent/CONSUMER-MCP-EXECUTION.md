...
| Consumer capability coverage | Mechanically classified; 28 executable, 8 secure handoffs, 2 missing adapters, 1 not applicable | Generated topology check validates every executable/handoff tool against its definition, handler and server registration; finance and durable task adapters remain open |
