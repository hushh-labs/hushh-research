...
- Current publication head: `84a886b97eb2e1c99e0e0e0a917a134254b78943` on `origin/feat/consumer-mcp`; the latest source/test correction before the documentation publication is `3c72f66f9`. The branch contains the typed owner-pod task, canonical PKM memory, Puppy-bound lifecycle, setup-status, connection, integration, calendar, people, Gmail, email-handoff and finance capability slices described by the dated receipts below. No deployment or hosted migration has been performed; the installed dev evidence remains separate from this branch.
...
## Current branch reconciliation — 12 September 2026 (`84a886b97`)

- `feat/consumer-mcp` is clean and remote-matched at `84a886b97eb2e1c99e0e0e0a917a134254b78943`; it remains 139 commits behind `origin/main`. No main merge, deployment, hosted migration, IAM change, credential mutation or marketplace submission occurred.
