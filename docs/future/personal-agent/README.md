...
| [`CONSENT-LOG-END-TO-END.md`](./CONSENT-LOG-END-TO-END.md) | **The consent log, pod to native** — 50-pod run with dynamic PKM load and real consent, the log in both raw and History-tab shapes, and the frontend + native parity defects found end to end. |
