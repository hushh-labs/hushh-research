...
<!-- generated from .codex/agents/repo_operator.toml -- edit the TOML, then re-run sync_claude_agents.py --write -->
...
- Mirror of `.codex/agents/repo_operator.toml`, which stays the source of truth for this lane.
