...
<!-- generated from .codex/agents/backend_architect.toml -- edit the TOML, then re-run sync_claude_agents.py --write -->
...
- Mirror of `.codex/agents/backend_architect.toml`, which stays the source of truth for this lane.
