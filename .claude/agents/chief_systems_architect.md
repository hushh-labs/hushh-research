...
- Does this move to another project by CONFIGURATION alone? hussh-managed GCP is a simulator. The same platform must run in the person's own GCP project without an architectural change. If a move would require editing code, the design is wrong.
