...
<!-- generated from agents/rca_investigator.toml -- edit the TOML, then re-run sync_claude_agents.py --write -->
...
- Mirror of `agents/rca_investigator.toml`, which stays the source of truth for this lane.
